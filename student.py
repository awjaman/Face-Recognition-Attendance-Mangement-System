...
#=======================variables===================
    ...
    # First Img
        img = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\face-recognition.png")
...
# -----------------------------------------------------------------
 # Second img
        img1 = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\smart-attendance.jpg")
   ...
   # ---------------------Third Image------------------
        ...
        img2 = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\clg.jpg")
...
# --------------------------background image ------------------
        img3 = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\bgimg.jpg")
...
# -------------------------Built a Frame ---------------------------------------------
        ...
        img_left = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\AdobeStock_303989091.jpeg")
        ...
        current_course_frame = LabelFrame(Left_frame, bg="white", bd=2, relief=RIDGE, text="Student Details",
                                font=("times new Roman", 12, "bold"))
        ...
        class_div_label = Label(class_Student_frame, text="Class Division:",
                                  font=("times new Roman", 13, "bold"), bg="white")
        class_div_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)

        # class_div_entry = ttk.Entry(
        #     class_Student_frame,textvariable=self.var_div, width=20, font=("times new Roman", 13, "bold"))
        ...
        #     class_Student_frame,textvariable=self.var_gender, width=20, font=("times new Roman", 13, "bold"))
        ...
        dob_entry = ttk.Entry(
            class_Student_frame,textvariable=self.var_dob, width=20, font=("times new Roman", 13, "bold"))
        ...
        email_entry = ttk.Entry(
            class_Student_frame,textvariable=self.var_email, width=20, font=("times new Roman", 13, "bold"))
        ...
        phone_entry = ttk.Entry(
            class_Student_frame,textvariable=self.var_phone, width=20, font=("times new Roman", 13, "bold"))
        ...
        # Right Label Frame 
        Right_frame = LabelFrame(main_frame, bg="white", bd=2, relief=RIDGE, text="Current Course information",
                                font=("times new Roman", 12, "bold"))
        Right_frame.place(x=750, y=10, width=720, height=580)

        img_right = Image.open(
            r"C:\Users\pawan\Desktop\Face-Recognition\college_images\student.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost", user="root", password="",database="facial_recognizer")
...
# =============================Fetch Data================
    def fetch_data(self):
        conn = mysql.connector.connect(
            host="localhost", user="root", password="", database="facial_recognizer")
        my_cursor = conn.cursor()
        ...
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                messagebox.showerror(
                    "Error", f"Due To:{(es)}", parent=self.root)
